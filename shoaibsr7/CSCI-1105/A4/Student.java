...
/**
 * Class used to represents students in a University
 ...
 *
 * It is your job as the programmer of this class to chose the appropriate collection from the JCF for the
...
public class Student implements Serializable {
    ...
    //TODO: Chose a type for the enrolledCourses and previousCourses variable
    private Set<Course> enrolledCourses;
    private Set<Course> previousCourses;


    /**
     * Creates a new Student object given a name an a iD Number
     ...
     * Why is it a good idea to return a copy instead simply returning the list itself?
     * How are we limiting access to the enrolledCourses variable?
     *
     * You don't have to answer this question anywhere in the assignment BUT if can't think of why, ask me on the last day of class
     *
     * @return the student's courses.
     */
    public Set<Course> getEnrolledCourses() {
        //TODO: fix the return type after you chosen the variable types
     ...
     * @param course the course add to the student's current course load.
     */
    ...
    public String getFullStudentInfo() {
        ...
        //Why? Strings are immutable. Everytime we += we are creating a new String.
     ...
     *    and all of its instances variables MUST implement the Serializable class.
     * The file is a binary file, therefore it is not human readable
     *
     * You don't need this method for the assigment. It is here as an example on how to save objects (there are multiple ways)
    ...
    public static List<Student> loadStudentsFromFile(String filename){
        try {
            ...
            System.out.println("Somethig went wrong while reading the students from file... here is the trace: ");
            e.printStackTrace();
        }
